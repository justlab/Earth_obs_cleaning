...
dt <- copy(tar_read(initial_cv_l2)$mDT_wPred)
```
...
tar_load(initial_cv_l2)
shaps <- initial_cv_l2$"shap_score"
# sort by importance
...
shap_long <- shap.prep(shap_contrib = initial_cv_l2$shap_score,
                       X_train = initial_cv_l2$mDT_wPred[, names(initial_cv_l2$shap_score), with = F])
# **SHAP summary plot**
