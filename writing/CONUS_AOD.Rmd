...
```{r plot_by_month, echo=FALSE, eval=FALSE, dev='png', dpi=300}
# Color by quantiles
...
```{r strata_timecalipers, echo=FALSE, fig.pos="H"}
...
```{r error_envelope_AMT2018, echo=FALSE}
...
```{r pred.map.median.mse, echo = F, eval=FALSE}
pred.map(
...
```{r pred.map.baltimore, echo = F, eval=FALSE}
pred.map(
