...
```{r plot_by_month, dev='png', dpi=300}
# Color by quantiles
...
The original error envelope (reported in the AMT MAIAC publication) had `r dt[, round(100 * mean(y.sat > (y.ground - 0.05 - 0.1*y.ground) & y.sat < (y.ground + 0.05 + 0.1*y.ground)))][1]`% coverage in our data.
