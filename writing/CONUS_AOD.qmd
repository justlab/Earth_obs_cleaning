...
@tbl-cv-overall includes the performance metrics for the full cross-validated training data set. Here **raw** is Collection 6.1 MAIAC AOD 470nm; **ground** is AERONET AOD interpolated to 470nm; and **corrected** is MAIAC after applying an XGBoost-modeled correction term.
...
#| fig-cap: Maps of typical MAIAC and Corrected AOD. Day selected as having the median improvement in MSE at AERONET sites.
