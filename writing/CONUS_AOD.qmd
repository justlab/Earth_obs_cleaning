...
agreement.plot = \(vname.pred)
   {d = dt[, .(y.ground, y.pred = get(vname.pred))]
    ...
    ggplot() +
        ...
        labs(caption = paste0("Not shown: ", d[!i, .N], " AOD values outside [0, 1]"))}

agreement.plot("y.sat") + agreement.plot("y.ground.pred")
```
...
g1 <- shap.plot.dependence(data_long = shap_long, x = 'time.sat', y = 'Column_WV', color_feature = 'Column_WV') +
