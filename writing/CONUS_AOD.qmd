...
@tbl-cv-overall includes the performance metrics for the full cross-validated training data set. Here **raw** is MCD19A2.V061 MAIAC AOD 470nm; **ground** is AERONET AOD interpolated to 470nm; and **corrected** is MAIAC after applying an XGBoost-modeled correction term.
